                            ...
                            <div class="card card-custom bg-body border-0 h-md-100">
                                ...
                                <div class="card-body d-flex justify-content-center flex-wrap ps-xl-15 pe-0">
                                    ...
                                    <div class="flex-grow-1 mt-2 me-9 me-md-0">
                                        <!--begin::Title-->
                                        <div class="position-relative text-gray-800 fs-1 z-index-2 fw-bold mb-5">N10 Fitness
                                            Client</div>
                                        <!--end::Title-->
                                        <!--begin::Text-->
                                        <span class="text-gray-600 fw-semibold fs-6 mb-6 d-block">N10 Fitness Client
                                            Side</span>
                                        <!--end::Text-->
                                        <!--begin::Action-->
                            ...
                            <div class="d-flex flex-wrap flex-sm-nowrap">
                                ...
                                <div class="me-7 mb-4">
                                    <div class="symbol symbol-100px symbol-lg-160px symbol-fixed position-relative">
                                        <img src="{{asset('assets/media/sample/bodybuilding.png')}}" alt="image">
                                    ...
                                    <div class="d-flex justify-content-between align-items-start flex-wrap mb-2">
                                        ...
                                        <div class="d-flex flex-column">
                                            ...
                                            <div class="d-flex align-items-center mb-2">
                                                <a href="#" class="text-gray-900 text-hover-primary fs-2 fw-bold me-1">{{$program->program->title}}</a>
                                                <a href="#">
                                            ...
                                            <div class="d-flex flex-wrap fw-semibold fs-6 mb-4 pe-2">
                                                ...
                                                <!--end::Svg Icon-->
                                                <strong>Weeks: </strong>{{$program->program->weeks}}</a>
                                                <a href="#" class="d-flex align-items-center text-gray-400 text-hover-primary me-5 mb-2">
                                                ...
                                                <!--end::Svg Icon--><strong>Days: </strong>{{$program->program->days}}</a>
                                        ...
                                        <div class="d-flex my-4">
                                            ...
                                            <a href="{{route('assigned.programs.view',$program->id)}}" class="btn btn-sm btn-primary me-2" >Open</a>
                                    ...
                                    <div class="d-flex flex-wrap flex-stack">
                                        ...
                                        <div class="d-flex align-items-center w-200px w-sm-300px flex-column mt-3">
                                            <div class="d-flex justify-content-between w-100 mt-auto mb-2">
                                                <span class="fw-semibold fs-6 text-gray-400">Program Compleation</span>
                                                <span class="fw-bold fs-6">{{getProgramCompletedPercentage()}}%</span>
                                            </div>
                                            <div class="h-5px mx-3 w-100 bg-light mb-3">
                                                <div class="bg-success rounded h-5px" role="progressbar" style="width: {{getProgramCompletedPercentage()}}%;" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100"></div>
                                            </div>
                                        </div>
                                        <!--end::Progress-->
                                    </div>
