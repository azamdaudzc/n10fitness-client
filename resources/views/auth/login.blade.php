			...
			<div class="d-flex flex-column flex-column-fluid flex-lg-row">
				...
				<div class="d-flex flex-center w-lg-50 pt-15 pt-lg-0 px-10">
					...
					<div class="d-flex flex-center flex-lg-start flex-column">
						<!--begin::Logo-->
						<a href="../../demo24/dist/index.html" class="mb-7">
							<img alt="Logo" src="assets/media/logos/logo.png" style="width: 200px" />
						</a>
						<!--end::Logo-->
						<!--begin::Title-->
						<h2 class="text-white fw-normal m-0">Fitness App For Everyone</h2>
						<!--end::Title-->
					</div>
					<!--begin::Aside-->
				</div>
